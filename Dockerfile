...
RUN Rscript -e 'remotes::install_version("broom",upgrade="never", version = "0.7.4")'
RUN Rscript -e 'remotes::install_version("agricolae",upgrade="never", version = "1.3-3")'
...
CMD R -e "options('shiny.port'=$PORT,shiny.host='0.0.0.0');ANOVA::run_app()"
